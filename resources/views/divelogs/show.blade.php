    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
          <a href="{{ route('divelogs.index') }}" class="text-blue-500 hover:text-blue-700 mr-2">BACK</a>
          ...
          <div class="text-gray-600 dark:text-gray-400 text-sm">
            <p>Create Date: {{ $divelog->created_at->format('Y-m-d H:i') }}</p>
          ...
          <div class="flex mt-4">
            ...
            <form action="{{ route('divelogs.destroy', $divelog) }}" method="POST" onsubmit="return confirm('本当に削除しますか？');">
              @csrf
              @method('DELETE')
